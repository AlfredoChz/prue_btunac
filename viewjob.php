  ...
  ?> 
           <div class="container">
             <div class="mg-available-rooms">
                    <h5 class="mg-sec-left-title">Fecha Publicada :  <?php echo date_format(date_create($result->DATEPOSTED),'M d, Y'); ?></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row contentbody">
                                            <div class="col-sm-6">
                                                <ul>
                                                    <li><i class="fp-ht-bed"></i>Numero de Empleados Requeridos : <?php echo $result->REQ_NO_EMPLOYEES; ?></li>
                                                    <li><i class="fp-ht-food"></i>Salario : <?php echo number_format($result->SALARIES,2);  ?></li>
                                                    <li><i class="fa fa-sun-"></i>Duracion del Empleo : <?php echo $result->DURATION_EMPLOYEMENT; ?></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-6">
                                                <ul>
                                                    <!-- <li><i class="fp-ht-dumbbell"></i>Qualification/Work Experience : <?php echo $result->QUALIFICATION_WORKEXPERIENCE; ?></li> -->
                                                    <li><i class="fp-ht-tv"></i>Genero : <?php echo $result->PREFEREDSEX; ?></li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <p>Ubicacion :  <?php echo  $result->COMPANYADDRESS; ?></p>
                                            </div>
                                        </div>
