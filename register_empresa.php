<section id="content">
    <div class="container content">
        ...
        <form class="row form-horizontal span6  wow fadeInDown" action="process.php?action=register_enterprise" method="POST">
            <h2 class=" ">Información de la Empresa</h2>
            <div class="row">
                <div class="form-group">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                            ...
                            <input class="form-control input-sm" id="RUC" name="RUC" placeholder=
                            "RUC" type="text" value=""  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <label class="col-md-4 control-label" for=
                        "N_EMPRESA">Nombre</label>

                        <div class="col-md-8">
                            <input name="deptid" type="hidden" value="">
                            <input  class="form-control input-sm" id="N_EMPRESA" name="N_EMPRESA" placeholder=
                            "Nombre"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!--<div class="form-group">
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <label class="col-md-4 control-label" for=
                        "TELNO">Número Telefónico</label>

                        <div class="col-md-8">

                            <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                            "Número Telefónico" type="text" any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!--
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        ...
                        "EMAIL">Email</label>
                        <div class="col-md-8">
                            <input type="email" class="form-control input-sm" id="EMAIL" name="EMAIL" placeholder="Email"   autocomplete="false"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-8">
                        <label class="col-md-4 control-label" for=
                        "P_RESPONSABLE">Representante empresarial</label>

                        <div class="col-md-8">
                            <input name="deptid" type="hidden" value="">
                            <input  class="form-control input-sm" id="P_RESPONSABLE" name="P_RESPONSABLE" placeholder=
                            "Representante"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!--
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                            <button class="btn btn-primary btn-sm" name="btnRegister" type="submit" ><span class="fa fa-save fw-fa"></span> Registrar</button>
